...
class Panel(models.Model):
    ...
    pic = models.FileField("عکس بیوگرافی", upload_to='static_media/media/pic/', blank=True, null=True)
    biopic = models.FileField("عکس بیوگرافی پروفایل", upload_to='static_media/media/pic/', blank=True, null=True)
